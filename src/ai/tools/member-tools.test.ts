...
describe('Member Tools', () => {
  ...
  it('should get a single member by ID', async () => {
    const member = await createMemberTool.execute({ familyId, name: 'Jean', type: MemberType.adult as any });
  ...
  it('should delete a member', async () => {
    const member = await createMemberTool.execute({ familyId, name: 'Delete Me', type: MemberType.adult as any });
