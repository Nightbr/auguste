export function ThinkingBubble() {
  return (
    <div className="flex items-start mb-6">
      <div className="relative px-2 py-3 transition-all duration-300 bg-[#2d3a31]/20 backdrop-blur-md border border-white/5 shadow-md rounded-2xl flex items-center space-x-2">
