...
export const CreateFamilyInputSchema = createInsertSchema(family)
  .extend({
    name: z
      .string()
      .min(1)
      .describe('The family or household name (e.g., "The Smith Family", "Casa Garcia")'),
    country: z
      .string()
      .length(2)
      .describe(
...
export const UpdateFamilyInputSchema = z.object({
  ...
  country: z
    ...
    .length(2)
    .optional()
    .describe('ISO 3166-1 alpha-2 country code (2 letters). Examples: "US", "FR", "DE", "JP"'),
  language: z
    .string()
    .min(2)
    .optional()
    .describe('ISO 639-1 language code. Examples: "en", "fr", "es", "de"'),
});
